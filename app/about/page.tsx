    ...
    <ScrollArea className="w-full">
      <div className="w-full max-w-screen-xl mx-auto flex flex-col gap-y-7 px-10">
        <section className="py-10 flex gap-x-20 items-center justify-center">
          <div className={`${notoSans.className} text-4xl w-[32rem]`}>I'm a developer, student and explorer of cool stuff.</div>
        ...
        <section className="flex gap-x-32 border-t-2 py-8">
        ...
        <section className="flex gap-x-32 py-8 border-t-2">
